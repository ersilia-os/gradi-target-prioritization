...
4. **[Essentiality / vulnerability](docs/04_essentiality.md)**. Is the target required for fitness or survival? Combines direct *K. pneumoniae* Tn-seq (in vitro / in vivo) and CRISPRi with *E. coli* essentiality transfer and computational predictors (ProteomeLM-Ess, Geptop 2.0, DeeplyEssential, FBA on iYL1228).
